############################################################
## Bulk ATAC-seq full original analysis
## Fig. 4 / Supplementary Fig. 4 / Supplementary Fig. 5
##
## This script performs the full bulk ATAC-seq downstream
## analysis using the complete peak-level count matrix,
## sample metadata, and bigWig files.
##
## Main analysis steps:
## 1. Read peak-level count matrix and sample metadata
...
## 14. Generate IGV-like ATAC signal plots from bigWig files
##
## Note:
...
## bigWig files for IGV-like ATAC signal plots
...
## Gene coordinate table and RefSeq Select annotation for IGV-like plots
...
read_bw_region <- function(bw_file, roi) {
  rtracklayer::import(bw_file, which = roi, format = "BigWig")
}
